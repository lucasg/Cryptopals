 ...
 */
void hex_decode(int *hexstr, const char *symstr, size_t hexsize);

/*
 * Convert a integer based string into a bi-hex symbols representation, eg 'fa10e8deedbeaf'.
 * The symstr buffer should be at least twice as long than the hexstr. 
 */
void hex_encode(char *symstr, const int *hexstr, size_t hexsize);
 ...
 * The symstr buffer should be at least twice as long than the hexstr.
 */
void hex_decode_c(char *hexstr, const char *symstr, size_t hexsize);

/*
 * Convert a integer based string into a bi-hex symbols representation, eg 'fa10e8deedbeaf'.
 * The symstr buffer should be at least twice as long than the hexstr. 
 */
void hex_encode_c(char *symstr, const char *hexstr, size_t hexsize);
