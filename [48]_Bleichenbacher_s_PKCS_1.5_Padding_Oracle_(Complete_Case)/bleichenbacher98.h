...
struct bleichenbacher_98_t
{
	...
	/* Search space initial boundaries (2B and 3B -1) */
	mpz_t min_range, max_range;

	/* search domains : can accomodate multiple intervals */
	/*mpz_t *a,*b;*/
	/*size_t interval_count, int_array_size;*/
	struct b98_search_sets_t sets;
